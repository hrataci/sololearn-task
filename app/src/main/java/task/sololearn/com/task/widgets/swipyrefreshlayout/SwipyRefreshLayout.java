...
package task.sololearn.com.task.widgets.swipyrefreshlayout;
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    private void setPprogressEnd(){
       double end = getContext().getResources().getDimensionPixelOffset(R.dimen.action_open_margin_bottom) ;
        setProgressViewEndTarget(true,(int)end);
    }
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (mIsBeingDragged) {
                        ...
                        if (mDirection == SwipyRefreshLayoutDirection.TOP) {
                            ...
                            targetY = mOriginalOffsetTop - (int) ((slingshotDist * dragPercent) + extraMove)-200;
                        }
